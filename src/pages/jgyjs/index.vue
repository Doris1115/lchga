<template>
  <view class="content">
    <image class="logo" src="/static/image/bgjg.png"></image>
    <view class="contain">
      <view class="column01 clear-fix">
        <view class="pull-left clear-fix">
          <text>用心陪伴孩子成长</text>
          <image class="icon" src="/static/image/icon311.png" mode="scaleToFill"></image>
        </view>
